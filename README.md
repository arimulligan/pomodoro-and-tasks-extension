...
It blocks websites depending on the rest/work pomodoro interval, with a built in to-do list! It's your life balance helper.
...
1. Clone or download this repository:
   ```bash
   git clone https://github.com/arimulligan/pomodoro-and-tasks-extension.git
   ```
...
1. Clone the repository and make changes to the `background.js` or `popup.js` files as needed.
